...
@RequestMapping("/rest/brakeType")
public class BrakeTypeController {

	private final IBrakeTypeServices servBrakeType;
	private final IMessageServices servMessage;
	
	@PostMapping("/create")
	public ResponseEntity<ResponseDTO> create(@RequestBody(required = true) @Validated(ValidationGroups.Create.class) BrakeTypeReq req) 
			throws Exception{
		ResponseDTO r = new ResponseDTO();
		servBrakeType.create(req);
	...
	public ResponseEntity<Object> list() throws Exception{
		return ResponseEntity.ok(servBrakeType.list());
	}
}
