	...
	public static MotorcycleDTO buildMotorcycleDTO(Motorcycle moto) {
		return MotorcycleDTO.builder()
				...
				.vehicle(VehicleDTO.builder()
						...
						.vehicleType(moto.getVehicle().getVehicleType() != null ? moto.getVehicle().getVehicleType().getVehicle() : null)
						.category(moto.getVehicle().getCategory() != null ? moto.getVehicle().getCategory().getCategory() : null)
						.fuelType(moto.getVehicle().getFuelType() != null ? moto.getVehicle().getFuelType().getFuel() : null)
