	...
	public static MotorcycleDTO buildMotorcycleDTO(Motorcycle moto) {
		return MotorcycleDTO.builder()
				...
				.vehicle(VehicleDTO.builder()
						...
						.vehicleType(VehicleTypeMap.buildVehicleTypeDTO(moto.getVehicle().getVehicleType()))
						.category(CategoryMap.buildCategoryDTO(moto.getVehicle().getCategory()))
						.fuelType(FuelTypeMap.buildFuelTypeDTO(moto.getVehicle().getFuelType()))
