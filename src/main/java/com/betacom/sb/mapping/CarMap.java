	...
	public static CarDTO buildCarDTO(Car car) {
		return CarDTO.builder()
				...
				.vehicle(VehicleDTO.builder()
						...
						.vehicleType(car.getVehicle().getVehicleType() != null ? car.getVehicle().getVehicleType().getVehicle() : null)
						.category(car.getVehicle().getCategory() != null ? car.getVehicle().getCategory().getCategory() : null)
						.fuelType(car.getVehicle().getFuelType() != null ? car.getVehicle().getFuelType().getFuel() : null)
